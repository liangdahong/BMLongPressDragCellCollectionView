...
#import "BMDidenticalSizeCellVC.h"
...
@interface BMDidenticalSizeCellVC () <BMDragCellCollectionViewDelegate, BMDragCollectionViewDataSource>
...
@implementation BMDidenticalSizeCellVC
...
- (void)viewDidLoad {
    ...
    for (int i = 1; i <= 80; i++) {
        ...
        [_dataSource addObject:@{@"color" : color,
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return [_dataSource[indexPath.item][@"size"] CGSizeValue];
}
