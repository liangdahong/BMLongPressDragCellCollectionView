...
#import "BMDidenticalSizeGroupCellVC.h"
...
@interface BMDidenticalSizeGroupCellVC () <BMDragCellCollectionViewDelegate, BMDragCollectionViewDataSource>
...
@implementation BMDidenticalSizeGroupCellVC
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return [_dataSource[indexPath.section][indexPath.item][@"size"] CGSizeValue];
}
